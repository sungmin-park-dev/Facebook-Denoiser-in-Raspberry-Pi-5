#!/usr/bin/env python3
"""
RP5-A Full-Duplex DEBUG Starter
================================

Interactive device selection for RP5-A
"""
...
def main():
    print("\n" + "="*60)
    print("🚀 RP5-A Full-Duplex DEBUG Starter")
    print("="*60)
    print("\nRole: A (Access Point)")
    print("Peer: RP5-B")
    ...
    print(f"   Peer IP: 10.42.0.224 (RP5-B)")
    print(f"   Send Port: 9999 → RP5-B:9999")
    print(f"   Recv Port: 9998 ← RP5-B:9998")
    print("="*60)
