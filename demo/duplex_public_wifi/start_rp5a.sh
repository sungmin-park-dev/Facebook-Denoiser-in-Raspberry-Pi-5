#!/bin/bash
# RP5-A Integrated Launch Script
# Automatically sets performance mode and starts communication

set -e

PROJECT_DIR="/home/test1/denoiser"
VENV_PYTHON="${PROJECT_DIR}/venv/bin/python"
SCRIPT_PATH="${PROJECT_DIR}/demo/duplex/rp5_full_duplex_modular.py"
CONFIG_PATH="${PROJECT_DIR}/demo/duplex/configs/rp5a_modular.yaml"

echo "=================================================="
echo "🚀 RP5-A Full-Duplex Launch"
echo "=================================================="
echo ""
...
echo "---------------------------------------------------"
echo "  Role: RP5-A (Hotspot Host)"
echo "  Config: rp5a_modular.yaml"
echo "  Buffer: 10 frames"
echo ""
